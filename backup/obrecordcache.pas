...
type
  ...
  public type
    ...
    TAfterCreateEvent = procedure(const AKey: ShortString; var AValue: TEntry) of object;
    TBeforeFreeEvent  = procedure(const AKey: ShortString; var AValue: TEntry) of object;
...
begin
  ...
  begin
    ...
    if Assigned(FOnBeforeFree) then
      FOnBeforeFree(lEntry^.Key, lEntry^);
